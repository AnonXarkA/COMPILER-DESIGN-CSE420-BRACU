...
static const yytype_uint8 yyprhs[] =
{
     ...
     103,   109,   115,   119,   121,   124,   126,   131,   133,   137,
     139,   143,   145,   149,   151,   155,   157,   161,   164,   167,
     169,   171,   176,   180,   182,   184,   187,   190,   192,   196
};
...
static const yytype_int8 yyrhs[] =
{
      ...
      51,    53,    29,    50,    -1,     3,    28,    53,    29,    50,
       4,    50,    -1,     6,    28,    53,    29,    50,    -1,    19,
      28,    36,    29,    34,    -1,    10,    53,    34,    -1,    34,
      -1,    53,    34,    -1,    36,    -1,    36,    32,    53,    33,
      -1,    54,    -1,    52,    25,    54,    -1,    55,    -1,    55,
      26,    55,    -1,    56,    -1,    56,    24,    56,    -1,    57,
      -1,    56,    20,    57,    -1,    58,    -1,    57,    21,    58,
      -1,    20,    58,    -1,    27,    58,    -1,    59,    -1,    52,
      -1,    36,    28,    60,    29,    -1,    28,    53,    29,    -1,
      37,    -1,    38,    -1,    52,    22,    -1,    52,    23,    -1,
      61,    -1,    61,    35,    54,    -1,    54,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint16 yyrline[] =
{
       0,    32,    32,    39,    46,    57,    63,    74,    82,    92,
     100,   108,   116,   125,   132,   141,   150,   157,   164,   173,
     180,   187,   194,   203,   210,   219,   226,   233,   240,   247,
     254,   261,   268,   277,   284,   293,   300,   309,   316,   325,
     332,   341,   348,   357,   364,   373,   380,   389,   396,   403,
     412,   419,   426,   433,   440,   447,   454,   463,   472,   479
};
#endif
...
static const yytype_uint8 yydefact[] =
{
      ...
      35,    53,    54,    27,    25,     0,     0,    23,    26,    50,
       0,    37,    39,    41,    43,    45,    49,     7,    10,     0,
       0,     0,     0,     0,     0,    50,    47,    48,     0,     0,
       0,    21,    13,    24,    55,    56,     0,    34,     0,     0,
       0,     0,     9,    20,     0,     0,     0,    32,     0,    52,
      59,     0,    57,     0,    38,    40,    44,    42,    46,     0,
       0,     0,     0,    51,     0,    36,     0,     0,    30,    31,
      58,     0,     0,    29,    28
};
...
#line 93 "20301066.y"
    {
			...
			outlog<<(yyvsp[(1) - (4)])->getname()<<","<<(yyvsp[(3) - (4)])->getname()<<(yyvsp[(4) - (4)])->getname()<<"\n"<<endl<<endl;
			
			(yyval) = new symbol_info((yyvsp[(1) - (4)])->getname()+","+(yyvsp[(3) - (4)])->getname()+(yyvsp[(4) - (4)])->getname()+"\n","parameter_list");	
...
#line 101 "20301066.y"
    {
			...
			outlog<<(yyvsp[(1) - (3)])->getname()<<","<<(yyvsp[(3) - (3)])->getname()<<"\n"<<endl<<endl;
			
			(yyval) = new symbol_info((yyvsp[(1) - (3)])->getname()+","+(yyvsp[(3) - (3)])->getname()+"\n","parameter_list");
...
#line 109 "20301066.y"
    {
			...
			outlog<<(yyvsp[(1) - (2)])->getname()<<(yyvsp[(2) - (2)])->getname()<<"\n"<<endl<<endl;
			
			(yyval) = new symbol_info((yyvsp[(1) - (2)])->getname()+(yyvsp[(2) - (2)])->getname()+"\n","parameter_list");
...
#line 181 "20301066.y"
    {
			...
			outlog<<(yyvsp[(1) - (6)])->getname()<<","<<(yyvsp[(3) - (6)])->getname()<<"["<<(yyvsp[(5) - (6)])->getname()<<"]\n"<<endl<<endl;
			
			(yyval) = new symbol_info((yyvsp[(1) - (6)])->getname()+","+(yyvsp[(3) - (6)])->getname()+"["+(yyvsp[(5) - (6)])->getname()+"]\n","declaration_list");
		}
    break;
...
#line 333 "20301066.y"
    {
			...
			outlog<<(yyvsp[(1) - (3)])->getname()<<(yyvsp[(2) - (3)])->getname()<<(yyvsp[(3) - (3)])->getname()<<"\n"<<endl<<endl;
			
			(yyval) = new symbol_info((yyvsp[(1) - (3)])->getname()+(yyvsp[(2) - (3)])->getname()+(yyvsp[(3) - (3)])->getname()+"\n","logic_expression");
		}
    break;
...
#line 397 "20301066.y"
    {
			...
			outlog<<"!"<<(yyvsp[(2) - (2)])->getname()<<"\n"<<endl<<endl;
			
			(yyval) = new symbol_info("!"+(yyvsp[(2) - (2)])->getname()+"\n","unary_expression");
		}
    break;
...
int main(int argc, char *argv[])
{
	...
	yyin = fopen(argv[1], "r");
	outlog.open("20301066_log.txt", ios::trunc);
